...
Provides file I/O operations between the client and the sandboxed session's
persistent `/data` volume. Supports writing and reading text and binary files,
listing directory contents, and managing file paths within the data volume.
