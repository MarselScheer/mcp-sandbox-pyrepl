...
Manages Python package installation within sandboxed sessions using `uv`.
Supports installing packages with optional version specifiers, temporary network
access during installation, session-scoped virtual environments, and package
